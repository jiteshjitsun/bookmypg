    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('Hindi', 'Hindi'), ('English', 'English')], default='Hindi', max_length=10)),
                ('superhost', models.BooleanField(default=False)),
                ('email_verified', models.BooleanField(default=False)),
                ('email_secret', models.CharField(blank=True, default='', max_length=20)),
                ('login_method', models.CharField(choices=[('email', 'Email'), ('github', 'Github'), ('google', 'Google')], default='email', max_length=50)),
